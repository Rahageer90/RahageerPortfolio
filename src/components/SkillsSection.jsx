  ...
  const skillsData = [
    {
      ...
      skills: [
        ...
        { name: "ReAct Agents & Reasoning", rating: 5 },
        { name: "Vector Embeddings & RAG", rating: 5 },
        { name: "Semantic Search & Retrieval", rating: 5 },
        { name: "Large Language Models (LLMs)", rating: 5 },
      ],
    },
    {
      category: "AI / ML Core & Libraries",
      icon: Layers,
      skills: [
        { name: "Scikit-learn & XAI / LIME", rating: 5 },
        { name: "Pandas & NumPy", rating: 5 },
        { name: "Generative AI & NLP", rating: 5 },
        { name: "Computer Vision", rating: 4 },
        { name: "Anomaly Detection & Classify", rating: 4 },
        { name: "Feature Engineering & Tuning", rating: 5 },
      ],
    },
    {
      category: "Web & APIs",
      icon: Database,
      skills: [
        { name: "FastAPI & REST API Design", rating: 5 },
        { name: "PHP & MVC Architecture", rating: 4 },
        { name: "PostgreSQL & MySQL", rating: 4 },
        { name: "Google Gemini API & OpenAI", rating: 5 },
        { name: "Serper, Tavily, NewsAPI", rating: 5 },
        { name: "HTML/CSS & Tailwind CSS", rating: 4 },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: "AWS (ECS, S3, RDS, Lambda)", rating: 4 },
        { name: "Redis & ElastiCache", rating: 4 },
        { name: "Netlify & Aiven", rating: 4 },
